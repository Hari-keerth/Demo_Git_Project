...
const Agent = (() => {
    ...
    const DOM = {
        ...
        resumePreview: document.getElementById("resumeFilePreview"), // <-- ADD THIS
    ...
    function validateResume() {
        ...
        console.log("validateResume() called");

        const file = DOM.resume.files[0];

        console.log("Preview Element:", DOM.resumePreview);
